var applySettlementVM = new Vue({
	...
	mounted : function() {
		...
		this.loadWithdrawsettingmoneyfree();
		this.initTable();
	},
	methods : {
		...
		loadWithdrawsettingmoneyfree : function() {
			var that = this;
			that.$http.get('/withdraw/moneyfree').then(function(res) {
				that.moneyfree = res.body.data.moneyFree;
			});
		},
