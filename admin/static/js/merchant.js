			...
			$('.platform-table').bootstrapTable({
				...
				columns : [ {
					...
					formatter : function(value, row, index) {
						return [ '<button type="button" class="merchant-rate-btn btn btn-outline-info btn-sm" style="margin-right: 4px;">通道费率</button>', '<button type="button" class="merchant-edit-btn btn btn-outline-primary btn-sm" style="margin-right: 4px;">编辑</button>', '<button type="button" class="modify-login-pwd-btn btn btn-outline-secondary btn-sm" style="margin-right: 4px;">修改登录密码</button>','<button type="button" class="modify-login-pwd-btn btn btn-outline-secondary btn-sm" style="margin-right: 4px;">修改资金密码</button>', '<button type="button" class="del-merchant-btn btn btn-outline-danger btn-sm">删除</button>' ].join('');
					},
					events : {
